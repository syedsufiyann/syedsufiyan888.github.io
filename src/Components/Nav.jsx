    ...
    return (
        <div className="w-100 h-auto bg-blue-950 sticky top-0">
            <nav className="max-w-[1300px] mx-auto bg-blue-950 text-gray-100 flex items-center justify-between p-2 px-6 md:px-12 ">
                ...
                <ul className={`items-center gap-8 absolute  left-0 bg-blue-800/[.92]  w-screen h-auto flex flex-col top-14 py-12 md:hidden ease-in duration-300 z-10 ${open ? 'top-9' : 'top-[-450px]'}`}>
